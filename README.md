...
Bronze → Silver → Gold architecture with SCD Type-2 dimensions,
fact table modeling, data quality checks, orchestration, and job scheduling.
...
2. Run `08_master_pipeline`
3. Schedule the master notebook as a Databricks Job
